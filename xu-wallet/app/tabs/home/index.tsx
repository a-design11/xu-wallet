...
export default function Home() {
  ...
  // Active chain info for display in header
  ...
  const change24h = useMemo(() => {
    ...
    const weighted = tokens.reduce(
      (acc, x) => acc + (x.balanceUSD || 0) * (x.change24h || 0),
      0
    );
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: t.palette.bg }}>
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12 }}>
          ...
          <Pressable
            ...
            accessibilityLabel="Switch blockchain network"
          >
            <View
              style={{
                width: 9,
                height: 9,
                borderRadius: 5,
                backgroundColor: activeChainInfo.accent,
              }}
            />
            ...
            {activeAccount && (
              <View
                style={{
                  ...
                  borderWidth: 1.5,
                  borderColor: activeAccount.color,
                  alignItems: 'center',
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            {shortAddress ? (
              ...
              >
                ...
                <Text
                  variant="caption"
                  style={{ color: addressCopied ? t.palette.success : t.palette.textMuted }}
                >
            ...
            return (
              <Pressable
                ...
                style={({ pressed }) => ({
                  ...
                  borderWidth: 1,
                  borderColor: active ? cc.accent : t.palette.hairline,
                  opacity: pressed ? 0.85 : 1,
                })}
              >
        ...
        {/* ── Asset list header with Import Token button ─────── */}
        <View style={{
          flexDirection: 'row',
          alignItems: 'center',
          ...
          <Pressable
            ...
            accessibilityLabel="Import custom token"
          >
        ...
        <View style={{ paddingTop: 4 }}>
          {visibleTokens.length === 0 ? (
            <View style={{ padding: 32, alignItems: 'center', gap: 8 }}>
              ...
              {/* Quick import prompt when no tokens visible */}
              <Pressable
                onPress={() => setImportTokenOpen(true)}
                style={({ pressed }) => ({
                  marginTop: 8,
      ...
      {/* Blockchain Switcher Sheet */}
      <BlockchainSwitcherSheet
      ...
      {/* Wallet List Sheet */}
      <WalletListSheet
        visible={walletListOpen}
        onClose={() => setWalletListOpen(false)}
      />

      {/* Import Token Sheet — chain is locked to current selection at open time */}
      <ImportTokenSheet
        visible={importTokenOpen}
